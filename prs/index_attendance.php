...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Payroll - Attendance Machine Master</title>
        <!-- BEGIN: CSS Assets-->
...
<style>
    ...
    <div class="flex mt-[4.7rem] md:mt-0">
        ...
        <div class="content content--top-nav">
            <?php
                $menu_title = "General";
                $currentPage="Attendance Machine Master";
                include 'top.php'
            ?>
            <div class="intro-y flex items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">
                Attendance Machine Master
                </h2>
            </div>
                            ...
                            <div class="preview">
                               <div class="overflow-x-auto">
                                    <table id="table" class="table table-bordered table-striped " style="width:100%"  cellpadding="7px" >
                                            <thead>
                                            <tr>
                                                 <th width="5%">Terminal ID</th>
                                                <th width="10%">Description</th>
                                                <th width="15%">IP Addres</th>
                                ...
                                <div id="header-footer-modal-preview-view" class="modal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <input id="txt_mac_id" name="txt_mac_id" type="hidden" class="form-control rounded" placeholder="Block Id" readonly>

                                                <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_desc" class="form-label">Description</label>
                                                    <input id="txt_desc" name="txt_desc" type="text" class="form-control rounded" placeholder="Description">
                                                </div>
                                                <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_ipaddr" class="form-label">IP Address</label>
                                                    <input id="txt_ipaddr" name="txt_ipaddr" type="text" class="form-control rounded" placeholder="IP Address">
                                                </div>
            ...
            function load_data(id){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        $("#txt_mac_id").val(res.mac_id);
                        $("#txt_desc").val(res.mac_descr);
                        $("#txt_ipaddr").val(res.ipaddr);
                    }
                });
            }
