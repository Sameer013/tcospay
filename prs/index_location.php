...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Payroll - Location Master</title>
        <!-- BEGIN: CSS Assets-->
                                ...
                                <div id="header-footer-modal-preview-view" class="modal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <input id="txt_loccode" name="txt_loccode" type="hidden" class="form-control rounded" placeholder="Block Id" readonly>

                                                <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_location" class="form-label">Location</label>
                                                    <input id="txt_location" name="txt_location" type="text" class="form-control rounded" placeholder="Location">
                                                </div>
            ...
            function load_data(id){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        $("#txt_loccode").val(res.Loccode);
                        $("#txt_location").val(res.Location);
