<?php
	...
	$object = new stdClass();
	 	...
	 	$action = "<div class='flex justify-left items-center'>
					...
					<!--<a class='flex items-center mr-5' id=\"viewBtn\" href='javascript:;' onclick=\"load_data('$dcode ')\"
					...
					<a class='flex items-center mr-5' id=\"edit-button\" href='javascript:;' onclick=\"load_data('$dcode ')\"
					data-tw-toggle=\"modal\" data-tw-target=\"#header-footer-modal-preview-view\">
					...
					<a class=\"flex items-center text-danger\" href=\"javascript:;\" onclick=\"remove_data('$dcode ')\">
		...
		// $comp_id =$row['comp_id'];
        $object->comp_name	= $row['comp_name'];
	 	$object->PfEstbCode	= $row['PfEstbCode'];
	 	$object->EsiEstbCode = $row['EsiEstbCode'];
	 	$object->Add1	= $row['Add1'];
	 	$object->pf1	= $row['pf'];
        $object->esic 	= $row['esic'];
