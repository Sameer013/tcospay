...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Payroll - Allowances and Deductions</title>
        <!-- BEGIN: CSS Assets-->
...
<style>
    ...
    <div class="flex mt-[4.7rem] md:mt-0">
        ...
        <div class="content content--top-nav">
            <?php
                $menu_title = "General";
                $currentPage="Allowances and Deduction";
                include 'top.php'
            ?>
            <div class="intro-y flex items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">
                  Global Allowances and Deductions
                </h2>
            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <input id="txt_code" name="txt_code" type="hidden" class="form-control" placeholder="CODE" readonly>
                                                ...
                                                <div class="col-span-12 sm:col-span-6">
                                                    ...
                                                    <input id="txt_desc" name="txt_desc" type="text" class="form-control" placeholder="Description">
                                                </div>
                                                <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_flag" class="form-label">%flag</label>
                                                    <input id="txt_flag" name="txt_flag" type="text" class="form-control" placeholder="%flag">
                                                </div>
                                                <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_allow" class="form-label">Allowance or Deduction</label>
                                                    <!-- <input id="txt_allow" name="txt_allow" type="text" class="form-control" placeholder="All. or Ded"> -->
                                                    <div class="flex flex-col sm:flex-row mt-2">
                                                        <div class="form-check mr-2"> <input id="txt_flag" class="form-check-input border-4" type="radio" name="txt_allow" value="a" checked> <label for="txt_allow" class="form-check-label">Allowance</label> </div>
                                                        <div class="form-check mr-2 mt-2 sm:mt-0"> <input id="txt_flag" class="form-check-input border-4" type="radio" name="txt_allow" value="d"> <label for="txt_allow" class="form-check-label">Deduction</label> </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-12 sm:col-span-6">
                                                 ...
                                                 <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_stillvalid" class="form-label">Still Valid</label>
                                                    <!-- <select class="text-dark form-control" name="txt_stillvalid" id="txt_stillvalid" placeholder="Select">
                                                        <option value="True">True</option>
                                                        <option value="False">False</option>
                                                    </select>-->
                                                    <div class="flex flex-col sm:flex-row mt-2">
                                                        <div class="form-check mr-2"> <input id="txt_stillvalid" class="form-check-input border-4" type="radio" name="txt_stillvalid" value="True" checked> <label for="txt_stillvalid" class="form-check-label">True</label> </div>
                                                        <div class="form-check mr-2 mt-2 sm:mt-0"> <input id="txt_stillvalid" class="form-check-input border-4" type="radio" name="txt_stillvalid" value="False"> <label for="txt_stillvalid" class="form-check-label">False</label> </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- END: Modal Body -->
            ...
            function load_data(CODE){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        $("#txt_stillvalid").val(res.ALLREDNCONTINUITY);
                    }
                });
            }
