...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title>Payroll - Category Master</title>
        <!-- BEGIN: CSS Assets-->
                                ...
                                <div id="header-footer-modal-preview-view" class="modal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <input id="txt_cat_code" name="txt_cat_code" type="hidden" class="form-control rounded" placeholder="" readonly>

                                                <div class="col-span-12 sm:col-span-6">
                                                    <label for="txt_descr" class="form-label">Category</label>
                                                    <input id="txt_descr" name="txt_descr" type="text" class="form-control rounded" placeholder="Category">
                                                </div>
                                            </div>
                                            <!-- END: Modal Body -->
											</form>
